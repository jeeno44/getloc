...
<br>
Для подтверждения регистрации необходимо активировать ваш профиль. Для этого перейдите по ссылке: <br />
<a href="http://scan.{{env('APP_DOMAIN')}}/activated?code={{$user->activation_code}}">http://scan.{{env('APP_DOMAIN')}}/activated?code={{$user->activation_code}}</a><br />
<br />
