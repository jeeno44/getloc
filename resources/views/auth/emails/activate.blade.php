...
<br>
Для подтверждение регистрации и защиты от злоумышленников. Необходимо активировать ваш профиль. Для этого перейдите по ссылке: <a href="http://scan.{{env('APP_DOMAIN')}}/activated?code={{$user->activation_code}}"></a><br>
<br>
