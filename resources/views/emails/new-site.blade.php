                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td style="width: 560px;" width="560">
                                    <h2 style="text-align: center; font-size: 24px; color: #333; margin-bottom: 12px;">Сайт добавлен</h2>
                                    <p style="font-size: 14px; line-height: 22px; color: #333;">
                                        Ваш сайт <b>{{$site}}</b> уже обрабатывается.
                                    </p>
                                    <p style="font-size: 14px; line-height: 22px; color: #333;">
                                        Просмотреть состояние просчета вы можете в <a href="http://getloc.ru/account">личном кабинете</a>.
                                    </p>
                                </td>
                                <td style="width: 20px;" width="20"></td>
                            </tr>
